    ...
    <div class="container mx-auto px-4 py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        @if ($posts->count())
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($posts as $post)
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-xl
                        ...
                        <div class="p-6 flex flex-col justify-between flex-grow space-y-4">
                            ...
                            <h3 class="text-2xl font-bold">
                                <a href="{{ route('posts.show', $post->slug) }}"
                                    ...
                                    dark:hover:text-purple-400 transition-colors duration-300 link-style">
                            ...
                            <!-- Post Metadata -->
                            <div class="flex flex-wrap items-center text-sm space-x-2 text-gray-600 dark:text-gray-400">
                                ...
                                <div class="flex flex-wrap items-center space-x-2 mt-2">
                                    @foreach ($post->tags as $tag)
                                        <a href="{{ route('tags.showBySlug', $tag->slug) }}"
                                            class="text-sm bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-300 px-2 py-1 rounded-full hover:bg-purple-200 dark:hover:bg-purple-700 transition duration-200 link-style">
                                            #{{ $tag->name }}
                                        </a>
                                    @endforeach
                                </div>
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-gray-500 dark:text-gray-400">Try adjusting your search or filters to find what you're
                    looking for.</p>
            </div>
        @endif
    </div>
